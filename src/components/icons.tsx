export const LikeIcon = ({size,liked}:{
    size:"lg" | 'sm',
    liked?:boolean
}) => (
  <svg
    ...
    strokeWidth={1.5}
    stroke="currentColor"
    className={`inline-block ${size === 'lg' ? "size-6":"size-4"}`}
  >
    <path
      strokeLinecap="round"
...
export const PencilIcon = ({size}:{
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className={size === 'lg' ? "size-6":"size-4"}>
